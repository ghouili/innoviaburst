    ...
    <>
      ...
      <main id="main-content" className="pt-20 min-h-screen bg-background">
        ...
        */}
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 p-3 bg-card/95 backdrop-blur-sm border-t border-border z-50 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
